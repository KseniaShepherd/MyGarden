    ...
    return (
        <div className={s.footerContainer}>
            <div className={s.contact}>
                <p id={s.contact}>Contact</p>
                <p id={s.telnumber}>+49 999 999 99 99 </p>
                <div className={s.socialMedia}>
                    <figure>
                        <img src={instagramLogo} alt='instagramLogo' width='44' height='44' />
            ...
            <div className={s.address}>
                <p id={s.address}>Address</p>
                <a href='https://www.google.com/search?q=telranDE'>Linkstraße 2, 8 OG, 10785, Berlin, Deutschland</a>
                <div>
                    <p id={s.workingHours}>Working Hours:</p>
                    <p id={s.timeWork}>24 hours a day</p>
                </div>
